...
export interface TaskItem {
	...
	task?: string;
	/** Model selector forced for this spawn (fuzzy id, `provider/id`, or `@role` alias). Overrides settings and agent defaults. */
	model?: string;
...
export interface TaskParams {
	...
	/** The work (flat form). */
	task?: string;
	/** Model selector forced for this spawn (flat form); overrides settings and agent defaults. */
	model?: string;
